        ...
        <section class="content">
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Mahsulot qo'shish</h4>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('product-store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_name_uz" required class="form-control">
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_tags_en" class="form-control" required data-role="tagsinput">
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_tags_uz" class="form-control" required data-role="tagsinput">
                                            </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_size_uz" class="form-control" required data-role="tagsinput">
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_color_en" class="form-control" required data-role="tagsinput">
                                            </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_color_uz" class="form-control" required data-role="tagsinput">
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="file" name="product_thambnail" required onChange="mainThamUrl(this)" class="form-control" >
                                            </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="file" name="multi_img[]" required multiple="" id="multiImg" class="form-control" >
                                            </div>
                                            @error('product_img[]')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input name="short_descp_en" id="textarea" class="form-control" required placeholder="Textarea text">
                                            </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input name="short_descp_uz" id="textarea" class="form-control" required placeholder="Textarea text">
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <div class="form-group mt-4">
                                            <div class="demo-checkbox">
                                                        <input type="checkbox" name="hot_deals" id="basic_checkbox_1" value="1" />
                                    ...
                                    <div class="col-3">
                                        <div class="form-group mt-4">
                                            <div class="demo-checkbox">
                                                <input type="checkbox" name="featured" id="basic_checkbox_2" value="1" />
                                    ...
                                    <div class="col-3">
                                        <div class="form-group mt-4">
                                            <div class="demo-checkbox">
                                                <input type="checkbox" name="special_offer" id="basic_checkbox_3" value="1" />
                                    ...
                                    <div class="col-3">
                                        <div class="form-group mt-4">
                                            <div class="demo-checkbox">
                                                <input type="checkbox" name="special_dears" id="basic_checkbox_4" value="1" />
                                ...
                                <div class="form-group">
                                    <button class="btn btn-success" type="submit">Mahsulot qo'shish</button>
                                </div>
                            </form>
                        </div>
                    </div>
