                                ...
                                @foreach ($categories as $category)
                                    <li class="dropdown menu-item">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                                                class="icon {{ $category->category_icon }}"></i>
                                            ...
                                            <li class="yamm-content">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-3">
                                                        <h2 class="title">
                                                            @if (session()->get('language') == 'uzbek')
                                                                {{ $subcategory->subcategory_name_uz }}
                                                            @else
                                                    ...
                                                    @endphp
                                                     @foreach ($subsubcategories as $subsubcategory)
                                                            <ul class="links list-unstyled">
                                                                <li><a href="#">
                                                                   @if (session()->get('language') == 'uzbek')
                                                                {{ $subsubcategory->subsubcategory_name_uz }}
                                                            @else
                            ...
                            <div class="item item-carousel">
                                <div class="products">
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image"> <a href="detail.html"><img
                                                        src="{{ asset('frontend/assets/images/blank.gif" data') }}-echo="{{ asset('frontend/assets/images/products/p7.jpg') }}"
                                                        alt=""></a> </div>
                                            <!-- /.image -->
